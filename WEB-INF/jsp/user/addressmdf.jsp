...
<%@include file="/WEB-INF/jsp/common/head.jsp"%>
	<div class="body">
		<div class="location">
			...
			<strong>修改通讯录信息</strong>
		</div>
		<div class="Add">
			<form id="userForm" method="post" action="${path}/sys/saveaddressmdf">
					<div class="head">
    					<h1>修改通讯录</h1>
    				</div>
    				<div>
                        <input type="hidden" name="aid" id="aid" value="${address.aid }">
                        <font color="red"></font>
                    </div>
                    <div>
                        <label for="name">联系人名：</label>
                        <input type="text" name="name" id="name" value="${address.name }" placeholder="请输入联系人名">
                    ...
                    <div>
                        ...
                        <input type="text" name="sex" id="sex" value="${address.sex }" placeholder="请输入性别：男 / 女">
                    ...
                    <div>
                        ...
                        <input type="text" name="mobile" id="mobile" value="${address.mobile }" placeholder="请输入电话号码">
                    ...
                    <div>
                        ...
                        <input type="text" name="email" id="email" value="${address.email }" placeholder="请输入邮箱地址">
                    ...
                    <div>
                        ...
                        <input type="text" name="qq" id="qq" value="${address.qq }" placeholder="请输入qq号">
                    ...
                    <div>
                        ...
                        <input type="text" name="company" id="company" value="${address.company }" placeholder="请输入公司">
                    ...
                    <div>
                        ...
                        <input type="text" name="address" id="address" value="${address.address }" placeholder="请输入地址">
                    ...
                    <div>
                        ...
                        <input type="text" name="postcode" id="postcode" value="${address.postcode }" placeholder="请输入邮政编码">
